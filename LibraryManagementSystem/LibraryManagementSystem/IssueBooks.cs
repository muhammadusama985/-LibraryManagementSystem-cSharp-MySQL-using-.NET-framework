...
namespace LibraryManagementSystem
{
    public partial class IssueBooks : UserControl
    {
        ...
        public IssueBooks()
        {
            ...
            addBooksForm.BookAdded += AddBooksForm_BookAdded;
        ...
        private void AddBooksForm_BookAdded(object sender, EventArgs e)
        {
        ...
        public void DataBookTitle()
        {
            if(connect.State == ConnectionState.Closed)
            {
                ...
                {
                    connect.Open();
                    string selectData = "SELECT id, books_title FROM books WHERE status = 'Available' AND date_delete IS NULL";
                    ...
                    using (SqlCommand cmd = new SqlCommand(selectData, connect))
                    {
                        ...
                        bookIssue_bookTitle.DisplayMember = "books_title";
